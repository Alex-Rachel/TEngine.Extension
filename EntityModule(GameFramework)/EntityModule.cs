...
namespace GameLogic
{
    ...
    public sealed partial class EntityModule :SingletonBehaviour<EntityModule>
    {
        ...
        private void InitStart()
        {
            ...
            m_EntityManager.SetObjectPoolManager(ModuleSystem.GetModule<IObjectPoolModule>());
        ...
        {
            return await m_EntityManager.ShowEntityAsync<T>(entityId, entityAssetName, entityGroupName, priority, ShowEntityInfo.Create(typeof(T), userData));
        }
